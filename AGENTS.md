# Agent guide - crossterm-kotlin

This file is the quick-reference operating contract for crossterm-kotlin. The longer
...
crossterm-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`crossterm`](./README.md). Upstream Rust is the behavioral oracle while the
