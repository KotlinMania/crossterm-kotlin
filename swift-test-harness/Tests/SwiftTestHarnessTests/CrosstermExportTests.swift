...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Crossterm.swiftmodule/`
...
//      `import Crossterm` above would fail at compile time.
//
//   2. The static archive `libCrossterm.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Crossterm" }` and
//      `flattenPackage = "io.github.kotlinmania.crossterm"` configuration in
...
//      via the `CrosstermLibrary` product.
//
