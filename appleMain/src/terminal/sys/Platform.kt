...
// tcflag_t is UInt (32-bit) on Darwin Kotlin/Native interop.
...
private const val ICANON: UInt = 0x00000100u
private const val ISIG: UInt = 0x00000080u
private const val IEXTEN: UInt = 0x00008000u
private const val CSIZE: UInt = 0x00000300u
private const val PARENB: UInt = 0x00001000u
private const val CS8: UInt = 0x00000300u
