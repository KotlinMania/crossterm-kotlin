...
actual fun enableRawMode(): Unit = throw UnsupportedOperationException("Raw mode is not supported on JVM")

actual fun disableRawMode(): Unit = throw UnsupportedOperationException("Raw mode is not supported on JVM")
