...
sealed class Color : Comparable<Color> {
    ...
    companion object {
         ...
         */
        fun parseAnsi(ansi: String): Color? = parseAnsiIter(ansi.split(';').iterator())
         ...
         */
        fun fromString(src: String): Color = tryFrom(src) ?: White
