...
data class Attributes(
     ...
     */
    fun with(attribute: Attribute): Attributes = Attributes(bits or attribute.bytes())

    /**
     * Returns a copy of the bitset with the given attribute unset.
     * If it's not set, this returns the bitset unmodified.
     */
    fun without(attribute: Attribute): Attributes = Attributes(bits and attribute.bytes().inv())
     ...
     */
    fun set(attribute: Attribute): Attributes = Attributes(bits or attribute.bytes())
     ...
     * Use the returned value.
     */
    fun unset(attribute: Attribute): Attributes = Attributes(bits and attribute.bytes().inv())
     ...
     * Use the returned value.
     */
    fun toggle(attribute: Attribute): Attributes = Attributes(bits xor attribute.bytes())

    /**
     * Returns whether the attribute is set.
     */
    fun has(attribute: Attribute): Boolean = (bits and attribute.bytes()) != 0u
     ...
     * Use the returned value.
     */
    fun extend(attributes: Attributes): Attributes = Attributes(bits or attributes.bits)
     ...
     */
    infix fun and(attribute: Attribute): Attributes = Attributes(bits and attribute.bytes())

    /**
     * Bitwise AND with another Attributes.
     */
    infix fun and(other: Attributes): Attributes = Attributes(bits and other.bits)

    /**
     * Bitwise OR with an attribute.
     */
    infix fun or(attribute: Attribute): Attributes = Attributes(bits or attribute.bytes())

    /**
     * Bitwise OR with another Attributes.
     */
    infix fun or(other: Attributes): Attributes = Attributes(bits or other.bits)

    /**
     * Bitwise XOR with an attribute.
     */
    infix fun xor(attribute: Attribute): Attributes = Attributes(bits xor attribute.bytes())

    /**
     * Bitwise XOR with another Attributes.
     */
    infix fun xor(other: Attributes): Attributes = Attributes(bits xor other.bits)
    ...
    companion object {
         ...
         */
        fun from(attribute: Attribute): Attributes = Attributes(attribute.bytes())
         ...
         */
        fun of(vararg attributes: Attribute): Attributes = from(attributes.toList())
    }
}
