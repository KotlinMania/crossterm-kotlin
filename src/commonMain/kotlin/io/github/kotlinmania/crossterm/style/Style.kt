...
data class SetUnderlineColor(
    ...
    override fun executeWinapi(): Unit = throw IllegalStateException("SetUnderlineColor not supported by winapi.")
}
...
data class SetStyle(
    ...
    override fun executeWinapi(): Unit = throw IllegalStateException("tried to execute SetStyle command using WinAPI, use ANSI instead")
 ...
 */
data class PrintStyledContent(
    val styledContent: StyledContent,
) : Command {
    override fun writeAnsi(writer: Appendable) {
...
data class Print(
    ...
    override fun executeWinapi(): Unit = throw IllegalStateException("tried to execute Print command using WinAPI, use ANSI instead")
