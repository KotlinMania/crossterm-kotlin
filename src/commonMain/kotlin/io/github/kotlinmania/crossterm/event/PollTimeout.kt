...
class PollTimeout private constructor(
    ...
    companion object {
         ...
         */
        fun new(timeout: Duration?): PollTimeout = PollTimeout(timeout, TimeSource.Monotonic.markNow())
     ...
     */
    fun elapsed(): Boolean = timeout?.let { start.elapsedNow() >= it } ?: false
