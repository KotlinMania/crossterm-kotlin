...
data object CursorPositionFilter : Filter {
    override fun eval(event: InternalEvent): Boolean = event is InternalEvent.CursorPosition
}
...
data object PrimaryDeviceAttributesFilter : Filter {
    override fun eval(event: InternalEvent): Boolean = event is InternalEvent.PrimaryDeviceAttributes
}
...
data object EventFilter : Filter {
    override fun eval(event: InternalEvent): Boolean = event is InternalEvent.Event
}
